...
void TiXmlBase::ConvertUTF32ToUTF8(int input, char *output, int *length) {
  const int BYTE_MASK = 0xBF;
  const int BYTE_MARK = 0x80;
  const int FIRST_BYTE_MARK[7] = {0x00, 0x00, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC};
