...
extern SimplifyCamParams SimplifyfrontCamParams[2];
extern SimplifyCamParams SimplifyrearCamParams[2];
extern SimplifyCamParams SimplifyleftCamParams[2];
extern SimplifyCamParams SimplifyrightCamParams[2];
...
//#define PARADIR "../test/jiaobanche/pku.xml"
//#define PARADIR "/home/lk/project/qtTest/test/jiaobanche/pku.xml"
...
#define cvReadRawData(a1, a2, value_addr, c) read_param(value_addr, mat_node, nodename)
...
void readParamsXML(int flag)
{
	...
	//CvFileStorage* fs_read_xml = cvOpenFileStorage(PARADIR,memstorage,CV_STORAGE_READ);
	...
	cvReadRawData(fs_read_xml, mat_node, SimplifyfrontCamParams[flag].mrInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A2");
	cvReadRawData(fs_read_xml, mat_node, SimplifyfrontCamParams[flag].mtInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A3");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrearCamParams[flag].mrInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A4");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrearCamParams[flag].mtInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A5");
	cvReadRawData(fs_read_xml, mat_node, SimplifyleftCamParams[flag].mrInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A6");
	cvReadRawData(fs_read_xml, mat_node, SimplifyleftCamParams[flag].mtInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A7");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrightCamParams[flag].mrInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "A8");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrightCamParams[flag].mtInt, "i");
	...
	cvReadRawData(fs_read_xml, mat_node, SimplifyfrontCamParams[flag].mimdInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "B2");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrearCamParams[flag].mimdInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "B3");
	cvReadRawData(fs_read_xml, mat_node, SimplifyleftCamParams[flag].mimdInt, "i");

	mat_node = cvGetFileNodeByName(fs_read_xml, NULL, "B4");
	cvReadRawData(fs_read_xml, mat_node, SimplifyrightCamParams[flag].mimdInt, "i");
